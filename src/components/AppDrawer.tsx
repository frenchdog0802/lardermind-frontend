...
export type AppDrawerVariant = 'overlay' | 'rail';

interface AppDrawerProps {
  open: boolean;
  /** Desktop: persistent rail. Mobile: slide-over overlay. */
...
export function AppDrawer({
  ...
  const panel = (
    <aside
      className={
        isRail
          ? 'sticky top-0 h-[100dvh] w-72 shrink-0 bg-linen border-r border-line flex flex-col z-30'
          : `fixed inset-y-0 left-0 z-50 w-[min(20rem,88vw)] bg-linen border-r border-line flex flex-col shadow-lg transition-transform duration-200 ease-out ${
      ...
      aria-hidden={isRail ? undefined : !open}
    >
